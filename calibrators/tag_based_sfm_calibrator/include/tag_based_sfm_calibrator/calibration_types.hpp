...
#ifndef TAG_BASED_SFM_CALIBRATOR__CALIBRATION_TYPES_HPP_
#define TAG_BASED_SFM_CALIBRATOR__CALIBRATION_TYPES_HPP_
...
struct CalibrationData
{
  ...
  static constexpr int SHRD_GROUND_TAG_POSE_DIM = 5;  // cSpell:ignore SHRD
  ...
  std::map<std::pair<UID, UID>, double> detection_diagonal_ratio_map;
  ...
  std::map<UID, double> optimized_sensor_residuals_map;
...
#endif  // TAG_BASED_SFM_CALIBRATOR__CALIBRATION_TYPES_HPP_
