...
| `lidartag_process_noise_translation_dot`      | `double`              | `0.001`                          | Lidartag's process noise (translation velocity) in meter/second used in the Kalman filter's process noise covariance matrix (Q).                                                                                                                                                              |
