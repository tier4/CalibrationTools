...
| --------------------------- | -------------------------------------------- | -------------------------------------------------------------------------------------- |
| `camera_info`               | `sensor_msgs::msg::CameraInfo`               | Intrinsic parameters for the calibration camera. `camera_info` is defined in launcher. |
...
| `max_allowed_homography_error`                | `double`              | `0.5`                            | apriltag detection is discarded if the homography error is larger than `max_allowed_homography_error`.                                                                                                                                                                  |
...
| `max_no_observation_time`                     | `double`              | `3.0`                            | Hypotheses can timeout when a new observation arrives and the time difference (dt) exceeds the `max_no_observation_time` threshold for the same tag ID, or when the time difference between the latest observation and the earlier observation surpasses the threshold. |
...
| `lidartag_measurement_noise_translation`      | `double`              | `0.05`                           | The square of this value in meters is part of the input for the measurement noise covariance matrix (R) in the Kalman filter.                                                                                                                                           |
| `lidartag_measurement_noise_rotation`         | `double`              | `5.0`                            | The square of this value in degrees is part of the input for the measurement noise covariance matrix (R) in the Kalman filter.                                                                                                                                          |
| `lidartag_process_noise_translation`          | `double`              | `0.01`                           | The square of this value in meters is part of the input for the process noise covariance matrix (Q) in the Kalman filter.                                                                                                                                               |
| `lidartag_process_noise_translation_dot`      | `double`              | `0.001`                          | The square of this value in meter/second is part of the input for the process noise covariance matrix (Q) in the Kalman filter.                                                                                                                                         |
| `lidartag_process_noise_rotation`             | `double`              | `1.0`                            | The square of this value in degrees is part of the input for the process noise covariance matrix (Q) in the Kalman filter.                                                                                                                                              |
| `lidartag_process_noise_rotation_dot`         | `double`              | `0.1`                            | The square of this value in degree/second is part of the input for the process noise covariance matrix (Q) in the Kalman filter.                                                                                                                                        |
...
| `apriltag_measurement_noise_translation`      | `double`              | `0.2`                            | The square of this value in meters is part of the input for the measurement noise covariance matrix (R) in the Kalman filter.                                                                                                                                           |
| `apriltag_process_noise_translation`          | `double`              | `0.02`                           | The square of this value in meters is part of the input for the process noise covariance matrix (Q) in the Kalman filter.                                                                                                                                               |
