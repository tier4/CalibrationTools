...
@CalibratorRegistry.register_calibrator(
    project_name="xx1_gen2", calibrator_name="mapping_based_lidar_lidar_calibrator"
)
    ...
    def post_process(self, calibration_transforms: Dict[str, Dict[str, np.array]]):
        ...
        result = {
            self.sensor_kit_frame: dict(
                zip(self.calibration_base_lidar_frames, sensor_kit_to_calibration_lidar_transforms)
            )
        }
