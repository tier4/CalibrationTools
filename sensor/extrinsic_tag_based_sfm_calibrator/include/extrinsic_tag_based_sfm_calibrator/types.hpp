...
#ifndef EXTRINSIC_TAG_BASED_SFM_CALIBRATOR__TYPES_HPP_
#define EXTRINSIC_TAG_BASED_SFM_CALIBRATOR__TYPES_HPP_
...
template <>
struct hash<extrinsic_tag_based_sfm_calibrator::UID>
{
  std::size_t operator()(const extrinsic_tag_based_sfm_calibrator::UID & uid) const
  {
...
#endif  // EXTRINSIC_TAG_BASED_SFM_CALIBRATOR__TYPES_HPP_
