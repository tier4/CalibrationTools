...
#ifndef EXTRINSIC_TAG_BASED_SFM_CALIBRATOR__EXTRINSIC_TAG_BASED_SFM_CALIBRATOR_HPP_
#define EXTRINSIC_TAG_BASED_SFM_CALIBRATOR__EXTRINSIC_TAG_BASED_SFM_CALIBRATOR_HPP_
...
#include <extrinsic_tag_based_sfm_calibrator/ceres/calibration_problem.hpp>
