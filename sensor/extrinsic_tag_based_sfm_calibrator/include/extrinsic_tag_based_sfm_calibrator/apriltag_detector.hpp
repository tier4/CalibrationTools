...
#ifndef EXTRINSIC_TAG_BASED_SFM_CALIBRATOR__APRILTAG_DETECTOR_HPP_
#define EXTRINSIC_TAG_BASED_SFM_CALIBRATOR__APRILTAG_DETECTOR_HPP_

#include <extrinsic_tag_based_sfm_calibrator/apriltag_detection.hpp>
...
public:
  ...
  /*!
   * Detect all the apriltags in an image filtering by hamming distance and detection margin
   * If the tag size and intrinsics are known, it also estimates the 3d pose of the tag
...
#endif  // EXTRINSIC_TAG_BASED_SFM_CALIBRATOR__APRILTAG_DETECTOR_HPP_
