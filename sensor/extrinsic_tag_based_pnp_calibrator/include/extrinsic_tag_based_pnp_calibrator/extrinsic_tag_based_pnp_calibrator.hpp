...
#ifndef EXTRINSIC_TAG_BASED_PNP_CALIBRATOR__EXTRINSIC_TAG_BASED_PNP_CALIBRATOR_HPP_
#define EXTRINSIC_TAG_BASED_PNP_CALIBRATOR__EXTRINSIC_TAG_BASED_PNP_CALIBRATOR_HPP_

#include <extrinsic_tag_based_pnp_calibrator/calibration_estimator.hpp>
...
class ExtrinsicTagBasedPNPCalibrator : public rclcpp::Node
{
public:
  explicit ExtrinsicTagBasedPNPCalibrator(const rclcpp::NodeOptions & options);
...
#endif  // EXTRINSIC_TAG_BASED_PNP_CALIBRATOR__EXTRINSIC_TAG_BASED_PNP_CALIBRATOR_HPP_
