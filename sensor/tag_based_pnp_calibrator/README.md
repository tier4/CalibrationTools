...
| `tag_sizes`                                   | `std::vector<double>` | `[0.6, 0.6, 0.6, 0.6, 0.6, 0.6]` | Payload sizes of the tags corresponding to the IDs in meters.                                                                                             |
...
| `apriltag_max_convergence_translation`        | `double`              | `2.0`                            | Maximum translation error in centimeters allowed for an apriltag detection hypothesis to be considered as converged.                                      |
| `apriltag_new_hypothesis_translation`         | `double`              | `20.0`                           | Translation threshold in centimeters for generating a new hypothesis in apriltag tracking.                                                                |
