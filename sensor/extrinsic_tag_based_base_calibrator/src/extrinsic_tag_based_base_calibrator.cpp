  ...
  std::shared_ptr<std_srvs::srv::Empty::Response> response)
{
  ...
  CalibrationSceneExtractor calibration_scene_extrator(apriltag_parameters_);
  ...
  CalibrationScene scene1 = calibration_scene_extrator.processScene(
    scene1_sensor_calibration_image_name, scene1_external_camera_image_names);

  CalibrationScene scene2 = calibration_scene_extrator.processScene(
