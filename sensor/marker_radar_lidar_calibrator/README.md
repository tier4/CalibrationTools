...
| `max_calibration_range`                     | `double`      | `50.0`                                                  | Maximum range for calibration in meter.                                                                               |
| `background_model_timeout`                  | `double`      | `5.0`                                                   | Timeout in second for background model updates.                                                                       |
| `min_foreground_distance`                   | `double`      | `0.4`                                                   | Minimum distance in meter for the foreground extraction, typically double the background model leaf size.             |
| `background_extraction_timeout`             | `double`      | `15.0`                                                  | Timeout in second for background extraction processes.                                                                |
| `ransac_threshold`                          | `double`      | `0.2`                                                   | Threshold used for RANSAC inliers in meter.                                                                           |
...
| `reflector_radius`                          | `double`      | `0.1`                                                   | Radius of the reflector used in calibration in meter.                                                                 |
| `reflector_max_height`                      | `double`      | `1.2`                                                   | Maximum height of the reflector in meter.                                                                             |
| `max_matching_distance`                     | `double`      | `1.0`                                                   | Maximum threshold in meter for matching distance between lidar and radar.                                             |
| `max_initial_calibration_translation_error` | `double`      | `1.0`                                                   | Maximum allowable translation error in meter in calibration process, if it is more than the value, WARNING will show. |
